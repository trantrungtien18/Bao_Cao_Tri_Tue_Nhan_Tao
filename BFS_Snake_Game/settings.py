...
GAP_SIZE = 3  # Gap between adjacent squares
...
# If snake wins the game, wait for this amount of seconds before restarting
...
def get_neighbors(position):
    neighbors = [[position[0] + 1, position[1]],    # North
